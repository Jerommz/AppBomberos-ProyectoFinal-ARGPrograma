...
public class BomberoData {
    ...
    public List<Bombero> listarBomberosAdministracion() {
        String sql = "SELECT `id_bombero`, `dni`, `nombre_ape`, `grupo_sang`, `fecha`, `celular`, `codBrigada`, `estado` FROM `bombero`  ";
        List<Bombero> bomberos = new ArrayList<>();
        try {
            PreparedStatement ps = con.prepareStatement(sql);
    ...
    public List<Bombero> listarBomberosPorNombre(String nombre) {
    String sql = "SELECT `id_bombero`, `dni`, `nombre_ape`, `grupo_sang`, `fecha`, `celular`, `codBrigada`, `estado` FROM `bombero` WHERE `nombre_ape` LIKE ?";
    List<Bombero> bomberos = new ArrayList<>();
    try {
        PreparedStatement ps = con.prepareStatement(sql);
        ...
        JOptionPane.showMessageDialog(null, "Error en SQL al listar bomberos por nombre");
    }
    return bomberos;
}
